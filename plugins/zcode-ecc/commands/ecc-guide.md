...
Use this command as a conversational map of Everything ZCode. It should help the user discover the right ECC surface for their task without dumping the entire README or stale catalog counts.
