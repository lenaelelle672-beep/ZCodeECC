...
Create hook rules to prevent unwanted ZCode behaviors by analyzing conversation patterns or explicit user instructions.
...
For each approved rule, create a file at `.zcode/hookify.{name}.local.md`:
