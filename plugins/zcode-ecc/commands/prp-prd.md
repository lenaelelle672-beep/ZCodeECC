...
**Output path**: `.zcode/PRPs/prds/{kebab-case-name}.prd.md`

Create directory if needed: `mkdir -p .zcode/PRPs/prds`
...
**File**: `.zcode/PRPs/prds/{name}.prd.md`
...
Run: `/prp-plan .zcode/PRPs/prds/{name}.prd.md`
...
└─────────────────────────────────────────────────────────┘
                          ↓
┌─────────────────────────────────────────────────────────┐
│  GENERATE: Write PRD to .zcode/PRPs/prds/              │
└─────────────────────────────────────────────────────────┘
```
