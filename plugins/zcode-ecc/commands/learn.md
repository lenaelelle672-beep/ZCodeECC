...
Create a skill at `~/.zcode/skills/<pattern-name>/SKILL.md`:
...
- Validate `pattern-name` as a lowercase hyphenated slug. Reject path
  ...
  inside the approved skill root (`~/.zcode/skills/`).
...
5. Save to `~/.zcode/skills/<pattern-name>/SKILL.md`
...
The directory form and frontmatter matter because ZCode discovers
