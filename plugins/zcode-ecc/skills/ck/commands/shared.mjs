...
export const CK_HOME          = resolve(homedir(), '.zcode', 'ck');
...
export const SKILL_FILE       = resolve(homedir(), '.zcode', 'skills', 'ck', 'SKILL.md');
...
export function nativeMemoryDir(absolutePath) {
  ...
  return resolve(homedir(), '.zcode', 'projects', encoded, 'memory');
}
