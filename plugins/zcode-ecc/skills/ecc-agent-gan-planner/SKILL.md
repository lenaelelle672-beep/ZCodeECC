...
description: "ZCode role skill adapted from the ECC gan-planner agent. GAN Harness — Planner agent. Expands a one-line prompt into a full product specification with features, sprints, evaluation criteria, and design direction."
---

# gan-planner - ZCode Role Skill
...
- Original agent: `gan-planner`
- Original model preference: `sonnet`
- Original tool allowlist: `Read, Write, Grep, Glob`
