...
description: "ZCode role skill adapted from the ECC healthcare-reviewer agent. Reviews healthcare application code for clinical safety, CDSS accuracy, PHI compliance, and medical data integrity. Specialized for EMR/EHR, clinical decision support, and health information systems."
---

# healthcare-reviewer - ZCode Role Skill
...
- Original agent: `healthcare-reviewer`
- Original model preference: `opus`
