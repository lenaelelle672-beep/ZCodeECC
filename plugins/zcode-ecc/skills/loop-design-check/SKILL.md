...
① **Run it once by hand** (forces you to state exactly "how the judge decides") → ② harden into a skill / ZCode sub-agents (a main Claude loops, dispatching plan/build/judge) → ③ hang it on cron for full automation.
