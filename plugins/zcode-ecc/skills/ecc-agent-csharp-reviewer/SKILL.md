...
description: "ZCode role skill adapted from the ECC csharp-reviewer agent. Expert C# code reviewer specializing in .NET conventions, async patterns, security, nullable reference types, and performance. Use for all C# code changes. MUST BE USED for C# projects."
---

# csharp-reviewer - ZCode Role Skill
...
- Original agent: `csharp-reviewer`
