...
description: "ZCode role skill adapted from the ECC refactor-cleaner agent. Dead code cleanup and consolidation specialist. Use PROACTIVELY for removing unused code, duplicates, and refactoring. Runs analysis tools (knip, depcheck, ts-prune) to identify dead code and safely removes it."
---

# refactor-cleaner - ZCode Role Skill
...
- Original agent: `refactor-cleaner`
