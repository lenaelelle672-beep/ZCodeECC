...
description: "ZCode role skill adapted from the ECC gan-evaluator agent. GAN Harness — Evaluator agent. Tests the live running application via Playwright, scores against rubric, and provides actionable feedback to the Generator."
---

# gan-evaluator - ZCode Role Skill
...
- Original agent: `gan-evaluator`
- Original model preference: `sonnet`
- Original tool allowlist: `Read, Write, Bash, Grep, Glob`
