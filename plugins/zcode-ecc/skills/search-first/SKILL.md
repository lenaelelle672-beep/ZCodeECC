...
| Skills directory | `ls ~/.zcode/skills ~/.codex/skills` where applicable | Say no local skill catalog was available |
...
2. Is there an MCP for this? → Check `~/.zcode/settings.json` and search
3. Is there a skill for this? → Check `~/.zcode/skills/`
...
Agent(subagent_type="general-purpose", prompt="
  ...
  Search: npm/PyPI, MCP servers, ZCode skills, GitHub
  Return: Structured comparison with recommendation
")
```

Older ZCode docs may call this `Task(...)`; use the current agent/subagent
