...
mkdir -p ~/.zcode/rules/ecc

# Install common rules (required for all projects)
cp -r rules/common ~/.zcode/rules/ecc/

# Install language-specific rules based on your project's tech stack
cp -r rules/typescript ~/.zcode/rules/ecc/
cp -r rules/angular ~/.zcode/rules/ecc/
cp -r rules/vue ~/.zcode/rules/ecc/
cp -r rules/nuxt ~/.zcode/rules/ecc/
cp -r rules/python ~/.zcode/rules/ecc/
cp -r rules/golang ~/.zcode/rules/ecc/
cp -r rules/web ~/.zcode/rules/ecc/
cp -r rules/react-native ~/.zcode/rules/ecc/
cp -r rules/swift ~/.zcode/rules/ecc/
cp -r rules/php ~/.zcode/rules/ecc/
cp -r rules/ruby ~/.zcode/rules/ecc/
cp -r rules/arkts ~/.zcode/rules/ecc/
