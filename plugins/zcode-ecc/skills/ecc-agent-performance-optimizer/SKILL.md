...
description: "ZCode role skill adapted from the ECC performance-optimizer agent. Performance analysis and optimization specialist. Use PROACTIVELY for identifying bottlenecks, optimizing slow code, reducing bundle sizes, and improving runtime performance. Profiling, memory leaks, render optimization, and algorithmic improvements."
---

# performance-optimizer - ZCode Role Skill
...
- Original agent: `performance-optimizer`
