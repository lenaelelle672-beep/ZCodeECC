...
description: "ZCode role skill adapted from the ECC php-reviewer agent. Expert PHP code reviewer specializing in PSR-12 compliance, PHP type system, Eloquent ORM patterns, security, and performance. Use for all PHP code changes. MUST BE USED for PHP projects."
---

# php-reviewer - ZCode Role Skill
