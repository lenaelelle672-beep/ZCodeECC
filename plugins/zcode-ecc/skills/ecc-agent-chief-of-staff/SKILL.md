...
description: "ZCode role skill adapted from the ECC chief-of-staff agent. Personal communication chief of staff that triages email, Slack, LINE, and Messenger. Classifies messages into 4 tiers (skip/info_only/meeting_info/action_required), generates draft replies, and enforces post-send follow-through via hooks. Use when managing multi-channel communication workflows."
---

# chief-of-staff - ZCode Role Skill
...
- Original agent: `chief-of-staff`
- Original model preference: `sonnet`
- Original tool allowlist: `Read, Grep, Glob, Bash, Edit, Write`
...
- **Rules are system-injected**: `.zcode/rules/*.md` files load automatically every session. Unlike prompt instructions, the LLM cannot choose to ignore them.
...
- [ZCode](https://docs.anthropic.com/en/docs/claude-code)
