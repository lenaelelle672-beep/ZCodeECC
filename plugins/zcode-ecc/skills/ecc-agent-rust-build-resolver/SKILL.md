...
description: "ZCode role skill adapted from the ECC rust-build-resolver agent. Rust build, compilation, and dependency error resolution specialist. Fixes cargo build errors, borrow checker issues, and Cargo.toml problems with minimal changes. Use when Rust builds fail."
---

# rust-build-resolver - ZCode Role Skill
...
- Original agent: `rust-build-resolver`
