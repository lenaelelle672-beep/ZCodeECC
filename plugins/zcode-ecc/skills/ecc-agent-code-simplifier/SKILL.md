...
description: "ZCode role skill adapted from the ECC code-simplifier agent. Simplifies and refines code for clarity, consistency, and maintainability while preserving behavior. Focus on recently modified code unless instructed otherwise."
---

# code-simplifier - ZCode Role Skill
...
- Original agent: `code-simplifier`
