...
description: "ZCode role skill adapted from the ECC network-troubleshooter agent. Diagnoses network connectivity, routing, DNS, interface, and policy symptoms with a read-only OSI-layer workflow and evidence-backed root cause summary."
---

# network-troubleshooter - ZCode Role Skill
...
- Original agent: `network-troubleshooter`
- Original model preference: `sonnet`
- Original tool allowlist: `Read, Bash, Grep`
