...
description: "ZCode role skill adapted from the ECC rust-reviewer agent. Expert Rust code reviewer specializing in ownership, lifetimes, error handling, unsafe usage, and idiomatic patterns. Use for all Rust code changes. MUST BE USED for Rust projects."
---

# rust-reviewer - ZCode Role Skill
