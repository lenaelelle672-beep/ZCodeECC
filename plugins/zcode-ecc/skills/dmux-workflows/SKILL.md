---
name: dmux-workflows
description: "Multi-agent orchestration using dmux (tmux pane manager for AI agents). Patterns for parallel agent workflows across ZCode, Codex, OpenCode, and other harnesses. Use when running multiple agent sessions in parallel or coordinating multi-agent development workflows."
---
...
- Coordinating work across ZCode, Codex, and other harnesses
...
- Supports: ZCode, Codex, OpenCode, Cline, Gemini, Qwen
...
```
Pane 1 (ZCode): "Review the security of the auth module"
Pane 2 (Codex): "Refactor the utility functions for performance"
Pane 3 (ZCode): "Write E2E tests for the checkout flow"
```
...
| **ZCode Agent tool** | In-process subagent spawning | Programmatic parallelism within a session |
...
```json
{
  ...
  "seedPaths": [
    ...
    ".zcode/plan/workflow-e2e-test.json"
  ],
