...
This makes Flox a natural fit for any workflow where ZCode or other AI agents need to bootstrap project tooling on the fly.
...
The following skills are available as part of the [Flox ZCode plugin](https://github.com/flox/flox-agentic) for deeper integration:
