...
description: "ZCode role skill adapted from the ECC kotlin-build-resolver agent. Kotlin/Gradle build, compilation, and dependency error resolution specialist. Fixes build errors, Kotlin compiler errors, and Gradle issues with minimal changes. Use when Kotlin builds fail."
---

# kotlin-build-resolver - ZCode Role Skill
...
- Original agent: `kotlin-build-resolver`
