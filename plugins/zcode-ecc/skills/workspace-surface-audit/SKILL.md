...
description: "Audit the active repo, MCP servers, plugins, connectors, env surfaces, and harness setup, then recommend the highest-value ECC-native skills, hooks, agents, and operator workflows. Use when the user wants help setting up ZCode or understanding what capabilities are actually available in their environment."
---
...
- User says "set up ZCode", "recommend automations", "what plugins or MCPs should I use?", or "what am I missing?"
...
1. Repo surface
   ...
   - `.mcp.json`, `.lsp.json`, `.zcode/settings*.json`, `.codex/*`
