...
description: "ZCode role skill adapted from the ECC docs-lookup agent. When the user asks how to use a library, framework, or API or needs up-to-date code examples, use Context7 MCP to fetch current documentation and return answers with examples. Invoke for docs/API/setup questions."
---

# docs-lookup - ZCode Role Skill
...
- Original agent: `docs-lookup`
- Original model preference: `haiku`
- Original tool allowlist: `Read, Grep, mcp__context7__resolve-library-id, mcp__context7__query-docs`
