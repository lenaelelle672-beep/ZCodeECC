 ...
 * focuses the iTerm2 tab where ZCode runs. Outside iTerm2, falls back
 ...
 * ZCode process still owns the terminal emulator's tty (e.g. iTerm2 tab).
 ...
 * notification focuses the exact tab/window where ZCode is running.
