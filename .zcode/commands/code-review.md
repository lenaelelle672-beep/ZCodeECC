...
1. **Project rules** — Read `AGENTS.md`, `.zcode/docs/`, and any contributing guidelines
2. **Planning artifacts** — Check `.zcode/prds/`, `.zcode/plans/`, `.zcode/reviews/`, and legacy `.zcode/PRPs/{prds,plans,reports,reviews}/` for context related to this PR
...
Create review artifact at `.zcode/reviews/pr-<NUMBER>-review.md` unless the repo already uses legacy `.zcode/PRPs/reviews/` for this workstream:
...
Artifacts:
  Review: .zcode/reviews/pr-<NUMBER>-review.md
  GitHub: <PR URL>
