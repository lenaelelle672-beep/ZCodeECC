...
```bash
python3 "${ZCODE_PLUGIN_ROOT}/skills/continuous-learning-v2/scripts/instinct-cli.py" prune
```

Or if `ZCODE_PLUGIN_ROOT` is not set (manual installation):

```bash
python3 ~/.zcode/skills/continuous-learning-v2/scripts/instinct-cli.py prune
```
