...
Write the full plan document using the template below. Save to `.zcode/PRPs/plans/{kebab-case-feature-name}.plan.md`.

Create the directory if it doesn't exist:
```bash
mkdir -p .zcode/PRPs/plans
```
...
```
.zcode/PRPs/plans/{kebab-case-feature-name}.plan.md
```
...
- **File**: .zcode/PRPs/plans/{kebab-case-feature-name}.plan.md
- **Source PRD**: [path or "N/A"]
...
> Next step: Run `/prp-implement .zcode/PRPs/plans/{name}.plan.md` to execute this plan.
```
