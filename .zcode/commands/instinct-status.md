...
This avoids the divergence that happens when `ZCODE_PLUGIN_ROOT` is unset
while a legacy `~/.zcode/skills/continuous-learning-v2/` directory still
exists (#2037).
...
2. Read project instincts from `~/.zcode/homunculus/projects/<project-id>/instincts/`
3. Read global instincts from `~/.zcode/homunculus/instincts/`
