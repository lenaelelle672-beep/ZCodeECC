---
description: "Generate a local ZCode cost report from the ECC cost-tracker metrics log."
argument-hint: "[csv]"
---

# Cost Report

Summarize local ZCode spend by day, model, and session from the metrics
...
1. Check that `~/.zcode/metrics/costs.jsonl` exists. If it does not, tell the
