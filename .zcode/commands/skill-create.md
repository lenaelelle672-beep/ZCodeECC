...
3. **Generates SKILL.md** - Creates valid ZCode skill files
...
`.zcode/skills/`; a global skill uses `~/.zcode/skills/`.
...
The directory form is required for discovery: ZCode treats
