...
| Write `.zcode/prds/{name}.prd.md` | Produce an implementation plan — that's `/plan` |
...
**Output path**: `.zcode/prds/{kebab-case-name}.prd.md`
...
```
PRD created: .zcode/prds/{name}.prd.md
...
Next step: /plan .zcode/prds/{name}.prd.md
