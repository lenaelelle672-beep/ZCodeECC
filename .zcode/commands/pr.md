...
- `.zcode/prds/` — PRDs this PR implements a milestone of
- `.zcode/plans/` — Plans executed by this PR
- `.zcode/PRPs/prds/` — legacy PRP PRDs
- `.zcode/PRPs/plans/` — legacy PRP implementation plans
- `.zcode/PRPs/reports/` — legacy PRP implementation reports
