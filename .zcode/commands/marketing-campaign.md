...
When saving campaign assets, the convention is `.zcode/campaigns/{campaign-name}/`:

```
.zcode/campaigns/product-launch/
├── positioning.md
├── landing-page.md
├── email-sequence.md
├── social-posts.md
...
```
/marketing-campaign review .zcode/campaigns/the-key/landing-page.md
```
...
*Part of [Everything ZCode](https://github.com/affaan-m/everything-claude-code)*
