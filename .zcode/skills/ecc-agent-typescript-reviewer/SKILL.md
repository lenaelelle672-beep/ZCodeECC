...
description: "ZCode role skill adapted from the ECC typescript-reviewer agent. Expert TypeScript/JavaScript code reviewer specializing in type safety, async correctness, Node/web security, and idiomatic patterns. Use for all TypeScript and JavaScript code changes. MUST BE USED for TypeScript/JavaScript projects."
---

# typescript-reviewer - ZCode Role Skill
...
- Original agent: `typescript-reviewer`
