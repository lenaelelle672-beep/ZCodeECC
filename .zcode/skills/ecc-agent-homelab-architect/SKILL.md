...
description: "ZCode role skill adapted from the ECC homelab-architect agent. Designs home and small-lab network plans from hardware inventory, goals, and operator experience level, with safe staged changes and rollback guidance."
---

# homelab-architect - ZCode Role Skill
...
- Original agent: `homelab-architect`
