...
Automatically evaluates ZCode sessions on end to extract reusable patterns that can be saved as learned skills.

## When to Activate

- Setting up automatic pattern extraction from ZCode sessions
- Configuring the Stop hook for session evaluation
- Reviewing or curating learned skills in `~/.zcode/skills/learned/`
...
3. **Skill Extraction**: Saves useful patterns to `~/.zcode/skills/learned/`
...
```json
{
  ...
  "auto_approve": false,
  "learned_skills_path": "~/.zcode/skills/learned/",
  "patterns_to_detect": [
    "error_resolution",
    "user_corrections",
    "workarounds",
...
Add to your `~/.zcode/settings.json`:
