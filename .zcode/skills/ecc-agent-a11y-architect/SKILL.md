...
description: "ZCode role skill adapted from the ECC a11y-architect agent. Accessibility Architect specializing in WCAG 2.2 compliance for Web and Native platforms. Use PROACTIVELY when designing UI components, establishing design systems, or auditing code for inclusive user experiences."
---

# a11y-architect - ZCode Role Skill
...
- Original agent: `a11y-architect`
- Original model preference: `sonnet`
- Original tool allowlist: `Read, Write, Edit, Grep, Glob`
