...
description: "ZCode role skill adapted from the ECC fastapi-reviewer agent. Reviews FastAPI applications for async correctness, dependency injection, Pydantic schemas, security, OpenAPI quality, testing, and production readiness."
---

# fastapi-reviewer - ZCode Role Skill
...
- Original agent: `fastapi-reviewer`
