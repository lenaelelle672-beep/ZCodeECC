...
description: "ZCode role skill adapted from the ECC dart-build-resolver agent. Dart/Flutter build, analysis, and dependency error resolution specialist. Fixes `dart analyze` errors, Flutter compilation failures, pub dependency conflicts, and build_runner issues with minimal, surgical changes. Use when Dart/Flutter builds fail."
---

# dart-build-resolver - ZCode Role Skill
...
- Original agent: `dart-build-resolver`
