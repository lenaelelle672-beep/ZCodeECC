...
description: "ZCode role skill adapted from the ECC cpp-reviewer agent. Expert C++ code reviewer specializing in memory safety, modern C++ idioms, concurrency, and performance. Use for all C++ code changes. MUST BE USED for C++ projects."
---

# cpp-reviewer - ZCode Role Skill
