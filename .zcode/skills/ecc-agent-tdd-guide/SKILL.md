...
description: "ZCode role skill adapted from the ECC tdd-guide agent. Test-Driven Development specialist enforcing write-tests-first methodology. Use PROACTIVELY when writing new features, fixing bugs, or refactoring code. Ensures 80%+ test coverage."
---

# tdd-guide - ZCode Role Skill
...
- Original agent: `tdd-guide`
- Original model preference: `sonnet`
- Original tool allowlist: `Read, Write, Edit, Bash, Grep`
