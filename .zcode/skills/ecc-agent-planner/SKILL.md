...
description: "ZCode role skill adapted from the ECC planner agent. Expert planning specialist for complex features and refactoring. Use PROACTIVELY when users request feature implementation, architectural changes, or complex refactoring. Automatically activated for planning tasks."
---

# planner - ZCode Role Skill
