...
description: "ZCode role skill adapted from the ECC opensource-forker agent. Fork any project for open-sourcing. Copies files, strips secrets and credentials (20+ patterns), replaces internal references with placeholders, generates .env.example, and cleans git history. First stage of the opensource-pipeline skill."
---

# opensource-forker - ZCode Role Skill
...
- Original agent: `opensource-forker`
...
rsync -av --exclude='.git' --exclude='node_modules' --exclude='__pycache__' \
  ...
  --exclude='.zcode/' --exclude='.secrets/' --exclude='secrets/' \
