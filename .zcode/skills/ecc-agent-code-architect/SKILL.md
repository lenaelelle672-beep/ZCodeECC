...
description: "ZCode role skill adapted from the ECC code-architect agent. Designs feature architectures by analyzing existing codebase patterns and conventions, then providing implementation blueprints with concrete files, interfaces, data flow, and build order."
---

# code-architect - ZCode Role Skill
