...
description: "ZCode role skill adapted from the ECC go-build-resolver agent. Go build, vet, and compilation error resolution specialist. Fixes build errors, go vet issues, and linter warnings with minimal changes. Use when Go builds fail."
---

# go-build-resolver - ZCode Role Skill
...
- Original agent: `go-build-resolver`
