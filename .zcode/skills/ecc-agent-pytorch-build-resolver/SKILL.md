...
description: "ZCode role skill adapted from the ECC pytorch-build-resolver agent. PyTorch runtime, CUDA, and training error resolution specialist. Fixes tensor shape mismatches, device errors, gradient issues, DataLoader problems, and mixed precision failures with minimal changes. Use when PyTorch training or inference crashes."
---

# pytorch-build-resolver - ZCode Role Skill
...
- Original agent: `pytorch-build-resolver`
