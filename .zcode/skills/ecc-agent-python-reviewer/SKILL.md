...
description: "ZCode role skill adapted from the ECC python-reviewer agent. Expert Python code reviewer specializing in PEP 8 compliance, Pythonic idioms, type hints, security, and performance. Use for all Python code changes. MUST BE USED for Python projects."
---

# python-reviewer - ZCode Role Skill
...
- Original agent: `python-reviewer`
