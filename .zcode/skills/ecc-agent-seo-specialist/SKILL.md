...
description: "ZCode role skill adapted from the ECC seo-specialist agent. SEO specialist for technical SEO audits, on-page optimization, structured data, Core Web Vitals, and content/keyword mapping. Use for site audits, meta tag reviews, schema markup, sitemap and robots issues, and SEO remediation plans."
---

# seo-specialist - ZCode Role Skill
...
- Original agent: `seo-specialist`
- Original model preference: `sonnet`
- Original tool allowlist: `Read, Grep, Glob, WebSearch, WebFetch`
