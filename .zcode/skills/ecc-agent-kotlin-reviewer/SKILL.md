...
description: "ZCode role skill adapted from the ECC kotlin-reviewer agent. Kotlin and Android/KMP code reviewer. Reviews Kotlin code for idiomatic patterns, coroutine safety, Compose best practices, clean architecture violations, and common Android pitfalls."
---

# kotlin-reviewer - ZCode Role Skill
...
- Original agent: `kotlin-reviewer`
