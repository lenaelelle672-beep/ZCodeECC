...
description: "ZCode role skill adapted from the ECC network-architect agent. Designs enterprise or multi-site network architecture from requirements, using existing network skills for focused routing, validation, automation, and troubleshooting detail."
---

# network-architect - ZCode Role Skill
...
- Original agent: `network-architect`
