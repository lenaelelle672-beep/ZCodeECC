  ...
  const tests = [
    ...
    ["npm pack publishes the reduced runtime surface", () => {
      ...
      for (const requiredPath of [
        ...
        "plugins/zcode-ecc/.zcode-plugin/plugin.json",
        "plugins/zcode-ecc/compatibility-manifest.json",
        ".zcode/compatibility-manifest.json",
        "scripts/zcode/build-adapter.js",
        "docs/ZCODE.md",
        "assets/ecc-icon.svg",
        "assets/hero.png",
